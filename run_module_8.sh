#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 08: Full DNS Attack Kill Chain
# ============================================================
# Usage:
#   sudo ./run_module_08.sh              (setup + demo)
#   sudo ./run_module_08.sh --guide-only (show guide only)
#   sudo ./run_module_08.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m08_kill_chain import KillChainModule
