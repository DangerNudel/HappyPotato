#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 01: DNS Cache Poisoning (Kaminsky Attack)
# ============================================================
# Usage:
#   sudo ./run_module_01.sh              (setup + demo)
#   sudo ./run_module_01.sh --guide-only (show guide only)
#   sudo ./run_module_01.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m01_cache_poison import CachePoisonModule
