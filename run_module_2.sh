#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 02: ARP + DNS Spoofing (LAN MITM)
# ============================================================
# Usage:
#   sudo ./run_module_02.sh              (setup + demo)
#   sudo ./run_module_02.sh --guide-only (show guide only)
#   sudo ./run_module_02.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m02_arp_spoof import ArpDnsSpoofModule
