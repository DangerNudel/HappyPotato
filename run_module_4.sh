#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 04: DNS Rebinding Attack
# ============================================================
# Usage:
#   sudo ./run_module_04.sh              (setup + demo)
#   sudo ./run_module_04.sh --guide-only (show guide only)
#   sudo ./run_module_04.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m04_rebinding import DnsRebindingModule
