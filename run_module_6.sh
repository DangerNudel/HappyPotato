#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 06: DNS Tunneling C2 and Exfiltration
# ============================================================
# Usage:
#   sudo ./run_module_06.sh              (setup + demo)
#   sudo ./run_module_06.sh --guide-only (show guide only)
#   sudo ./run_module_06.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m06_tunnel import DnsTunnelModule
