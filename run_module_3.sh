#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 03: Rogue DNS Server
# ============================================================
# Usage:
#   sudo ./run_module_03.sh              (setup + demo)
#   sudo ./run_module_03.sh --guide-only (show guide only)
#   sudo ./run_module_03.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m03_rogue_dns import RogueDNSModule
