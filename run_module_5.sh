#!/usr/bin/env bash
# ============================================================
# DNS Attack Lab — Module 05: NXDOMAIN Hijacking
# ============================================================
# Usage:
#   sudo ./run_module_05.sh              (setup + demo)
#   sudo ./run_module_05.sh --guide-only (show guide only)
#   sudo ./run_module_05.sh --demo-only  (skip setup)
# ============================================================
...
try:
    from modules.m05_nxdomain import NxdomainHijackModule
